...
// delta_con_high ~ normal(0,3);
  ...
  alpha[2:T,1] ~ normal(alpha[1:(T-1),1] - gamma11[1]*(alpha[1:(T-1),1] - (adj[1])*alpha[1:(T-1),2] + betax[1]*time_betax),
sigma_time[1]);
  alpha[2:T,2] ~ normal(alpha[1:(T-1),2] - gamma12[1]*(alpha[1:(T-1),2] - (1/adj[1])*alpha[1:(T-1),1] + betax[2]*time_betax),
sigma_time[2]);
  alpha[2:T,3] ~ normal(alpha[1:(T-1),3] - gamma21[1]*(alpha[1:(T-1),3] - (adj[2])*alpha[1:(T-1),4] + betax[3]*time_betax),
      sigma_time[3]);
