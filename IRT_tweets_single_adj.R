...
out_vec1 <- sapply(2:t,function(t_1) {
  ...
  if(t_1==1) {
    t_11 <- init_sides2[1] - gamma*(init_sides1[1] - omega*init_sides1[2]) + rnorm(1,sd=0.25)
    t_12 <- init_sides2[2] - gamma*(init_sides1[2]- omega*init_sides1[1]) + rnorm(1,sd=0.25)
  } else {
    t_11 <- current_val$t1 -  gamma*(current_val$t1- omega*current_val$t2) + rnorm(1,sd=0.25)
    t_12 <- current_val$t2 - gamma*(current_val$t2- omega*current_val$t1) + rnorm(1,sd=0.25)
  }
  current_val$t1 <- t_11
  current_val$t2 <- t_12
  return(c(t_11,t_12))
...
out_vec2 <- sapply(2:t,function(t_1) {
  if(t_1<(t/2)) {
    ...
    if(t_1==1) {
      t_11 <- init_sides2[1] - gamma*(init_sides2[1] - omega*init_sides2[2]) + rnorm(1,sd=0.25)
      t_12 <- init_sides2[2] - gamma*(init_sides2[2]- omega*init_sides2[1]) + rnorm(1,sd=0.25)
    } else {
      t_11 <- current_val$t1 -  gamma*(current_val$t1- omega*current_val$t2) + rnorm(1,sd=0.25)
      t_12 <- current_val$t2 - gamma*(current_val$t2- omega*current_val$t1) + rnorm(1,sd=0.25)
    }
